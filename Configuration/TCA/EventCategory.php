...
$GLOBALS['TCA']['tx_vjeventdb3_domain_model_eventcategory'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_vjeventdb3_domain_model_eventcategory']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_vjeventdb3_domain_model_eventcategory.pid=###CURRENT_PID### AND tx_vjeventdb3_domain_model_eventcategory.sys_language_uid IN (-1,0)',
			),
		),
		...
		'name' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:vjeventdb3/Resources/Private/Language/locallang_db.xlf:tx_vjeventdb3_domain_model_eventcategory.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
