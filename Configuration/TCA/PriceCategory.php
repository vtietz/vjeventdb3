...
$GLOBALS['TCA']['tx_vjeventdb3_domain_model_pricecategory'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_vjeventdb3_domain_model_pricecategory']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_vjeventdb3_domain_model_pricecategory.pid=###CURRENT_PID### AND tx_vjeventdb3_domain_model_pricecategory.sys_language_uid IN (-1,0)',
			),
		),
		...
		'name' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:vjeventdb3/Resources/Private/Language/locallang_db.xlf:tx_vjeventdb3_domain_model_pricecategory.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
